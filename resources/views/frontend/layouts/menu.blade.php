@php
    // Get the categories, sub categories and child categories with active status.
                ...
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        @foreach ($categories as $category)
                            <li><a class="{{ count($category->subCategories) ? 'wsus__droap_arrow' : '' }}"
                                    href="#"><i class="{{ $category->icon }}"></i>{{ $category->name }}
                                </a>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                        ...
                        @foreach ($categories as $category)
                            <li>
                                <a href="#"
                                    class="{{ count($category->subCategories) ? 'accordion-button' : '' }} collapsed"
